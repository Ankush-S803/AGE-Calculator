...
ttk.Label(root, text="Date of Birth (YYYY-MM-DD):").grid(column = 0,row=0,padx=10,pady=10)
birthdate_entry = ttk.Entry(root)
birthdate_entry.grid(column=1,row=0,padx=10,pady=5)

current_date = datetime.now().strftime("%Y-%m-%d")
ttk.Label(root, text = "Age at the date of (YYYY-MM-DD):").grid(column=0,row=1,padx=10,pady=10)
